...
const LandingPage = () => {
  return (
    <div style ={{ backgroundImage: `url("https://res.cloudinary.com/dev-ltd/image/upload/v1656756117/mqzehpcg5fic92fuqyza.png")`, width: "100%", maxWidth: "1200px", margin: "0 auto"}}>
        ...
        <Link to="/signup">
        <button type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">GET STARTED</button>
        </Link>
        <Link to="/login" className="cursor-pointer px-5 py-2.5 hover:underline">Sign In</Link>
        </div>
      <div style={{height: '450px'}} className="flex flex-col justify-center items-center">
